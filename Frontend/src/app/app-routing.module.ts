...
const routes: Routes = [
  ...
  {path:'home', component : HomeComponent , canActivate: [RoleGuard], data: { requiredRoles: ['Vendedor', 'Administrador','Bodeguero', 'Facturador'] }},
  ...
  {path:'usuario/listarUsuario', component: ListarUsuarioComponent, canActivate: [RoleGuard], data: { requiredRoles: [ 'Administrador'] }},
  {path:'usuario/crear', component: CrearUsuarioComponent, canActivate: [RoleGuard], data: { requiredRoles: ['Administrador'] }},
  {path:'usuario/modificarUsuario', component: ActualizarUsuarioComponent, canActivate: [RoleGuard], data: { requiredRoles: ['Administrador'] }},
  {path:'usuario/perfilUsuario', component: PerfilUsuarioComponent, canActivate: [RoleGuard], data: { requiredRoles: ['Vendedor', 'Administrador','Bodeguero', 'Facturador'] }},
